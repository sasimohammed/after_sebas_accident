...
public class InteractiveRestaurantSystem {
    ...
    private void initializeSystem() {
        ...
        orderSubject.addObserver(new WaiterNotification("WAITER_01"));
        orderSubject.addObserver(new WaiterNotification("WAITER_02"));
    ...
    private MenuItem createPizzaWithOptions() {
        ...
        MenuItem pizza = styleFactory.createPizza(pizzaName, description, totalPrice, selectedSize);
    ...
    private MenuItem createBurgerWithOptions() {
        ...
        MenuItem burger = styleFactory.createBurger(burgerName, description, basePrice);
    ...
    private MenuItem createPastaWithOptions() {
        ...
        MenuItem pasta = styleFactory.createPasta(pastaName, description, basePrice);
    ...
    private void displayMenuSamples() {
        ...
        System.out.println("\n🇮🇹 Italian Style:");
        vegFactory.getItalianStyle().createPizza("Margherita", "Fresh tomatoes & basil", 12.99, "Medium").display();
        vegFactory.getItalianStyle().createBurger("Portobello Burger", "Grilled mushroom", 10.99).display();

        System.out.println("\nEastern Style:");
        vegFactory.getEasternStyle().createPizza("Spicy Veggie", "Mixed vegetables & spices", 14.99, "Medium").display();
        vegFactory.getEasternStyle().createPasta("Curry Noodles", "Spicy vegetable curry", 13.99).display();
        ...
        System.out.println("\n🇮🇹 Italian Style:");
        nonVegFactory.getItalianStyle().createPizza("Pepperoni", "Spicy pepperoni & cheese", 15.99, "Large").display();
        nonVegFactory.getItalianStyle().createPasta("Chicken Alfredo", "Creamy chicken pasta", 16.99).display();

        System.out.println("\n Classic Style:");
        nonVegFactory.getClassicStyle().createBurger("Beef Classic", "Juicy beef patty", 12.99).display();
        nonVegFactory.getClassicStyle().createPasta("Meat Pasta", "With meat sauce", 14.99).display();
        ...
        System.out.println("\n🇮🇹 Italian Style:");
        kidsFactory.getItalianStyle().createPizza("Kids Cheese Pizza", "Simple cheese pizza", 8.99, "Small").display();
        kidsFactory.getItalianStyle().createPasta("Mini Pasta", "Small portion pasta", 7.99).display();

        System.out.println("\n🏛️ Classic Style:");
        kidsFactory.getClassicStyle().createBurger("Classic Kids Burger", "Simple chicken burger", 6.49).display();
    }
