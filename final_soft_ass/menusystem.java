...
// 3. Food Type Factory Interfaces (Open-Closed Principle)
...
// 4. Style Factory Interface (composes food type factories)
interface StyleFactory {
    PizzaFactory getPizzaFactory();
    BurgerFactory getBurgerFactory();
    PastaFactory getPastaFactory();
}

// 5. Concrete Food Type Factories
class ItalianPizzaFactory implements PizzaFactory {
    private String category;

    public ItalianPizzaFactory(String category) {
        this.category = category;
    }
...
class ItalianBurgerFactory implements BurgerFactory {
    private String category;

    public ItalianBurgerFactory(String category) {
        this.category = category;
    }
...
class ItalianPastaFactory implements PastaFactory {
    private String category;

    public ItalianPastaFactory(String category) {
        this.category = category;
    }
...
class EasternPizzaFactory implements PizzaFactory {
    private String category;

    public EasternPizzaFactory(String category) {
        this.category = category;
    }
...
class EasternBurgerFactory implements BurgerFactory {
    private String category;

    public EasternBurgerFactory(String category) {
        this.category = category;
    }
...
class EasternPastaFactory implements PastaFactory {
    private String category;

    public EasternPastaFactory(String category) {
        this.category = category;
    }
...
class ClassicPizzaFactory implements PizzaFactory {
    private String category;

    public ClassicPizzaFactory(String category) {
        this.category = category;
    }
...
class ClassicBurgerFactory implements BurgerFactory {
    ...
    public ClassicBurgerFactory(String category) {
        this.category = category;
    }
...
class ClassicPastaFactory implements PastaFactory {
    private String category;

    public ClassicPastaFactory(String category) {
        this.category = category;
    }
...
// 6. Concrete Style Factories (compose food type factories)
class ItalianStyleFactory implements StyleFactory {
    ...
    public PizzaFactory getPizzaFactory() {
        return new ItalianPizzaFactory(category);
    }

    @Override
    public BurgerFactory getBurgerFactory() {
        return new ItalianBurgerFactory(category);
    }

    @Override
    public PastaFactory getPastaFactory() {
        return new ItalianPastaFactory(category);
    }
}
...
class EasternStyleFactory implements StyleFactory {
    ...
    @Override
    public PizzaFactory getPizzaFactory() {
        return new EasternPizzaFactory(category);
    }

    @Override
    public BurgerFactory getBurgerFactory() {
        return new EasternBurgerFactory(category);
    }

    @Override
    public PastaFactory getPastaFactory() {
        return new EasternPastaFactory(category);
    }
}
...
class ClassicStyleFactory implements StyleFactory {
    ...
    @Override
    public PizzaFactory getPizzaFactory() {
        return new ClassicPizzaFactory(category);
    }

    @Override
    public BurgerFactory getBurgerFactory() {
        return new ClassicBurgerFactory(category);
    }

    @Override
    public PastaFactory getPastaFactory() {
        return new ClassicPastaFactory(category);
    }
}

// 7. Main Menu Factory Interface (Big Factory)
